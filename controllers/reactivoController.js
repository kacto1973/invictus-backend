...
const crearReactivo = async (req, res) => {
    try {
        ...
        // Validaciones
        if (!reactivo.idGabinete || !reactivo.idMarca || !reactivo.idUnidadMedida || !reactivo.idCategoria) {
        ...
        const idEstadoFisicoExistente = await EstadoFisico.findById(reactivo.idEstadoFisico);
